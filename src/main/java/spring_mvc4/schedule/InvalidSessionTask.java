 ...
 * 开辟一个线程中的任务执行器
 */
public class InvalidSessionTask extends TimerTask {

    private Log log = LogFactory.getLog(InvalidSessionTask.class);
    ...
    public InvalidSessionTask(List<HttpSession> list,Object lock){
        this.list = list;
        this.lock = lock;
    }
