...
public class LogAspect {
    ...
    @Pointcut("@annotation(spring.basics.aop.Action)")
    public void annotationPointCut(){};

    @Pointcut("execution(* spring.basics.aop.DemoMethodService.*(String))")
    ...
    @Before("execution(* spring.basics.aop.DemoMethodService.*())")
